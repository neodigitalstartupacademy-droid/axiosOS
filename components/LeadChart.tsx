  ...
  return (
    <div className="h-[550px] w-full glass-card p-14 rounded-[5rem] border border-white/5 flex flex-col min-w-0 shadow-3xl relative overflow-hidden group">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 relative z-10 gap-6">
        <div>
          <h3 className="text-[11px] font-black text-[#00d4ff] uppercase tracking-[0.5em] italic mb-3">Network Telemetry</h3>
          <p className="text-4xl font-black text-white tracking-tighter uppercase italic">Conversion Vectors</p>
        </div>
        <div className="flex gap-10">
           <div className="flex items-center gap-4">
              <div className="w-2.5 h-2.5 rounded-full bg-[#00d4ff] shadow-[0_0_15px_#00d4ff]"></div>
              <span className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Digital Clicks</span>
           </div>
           <div className="flex items-center gap-4">
              <div className="w-2.5 h-2.5 rounded-full bg-emerald-400 shadow-[0_0_15px_#34d399]"></div>
              <span className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Bio-Leads</span>
           </div>
        </div>
      </div>
      ...
      <div className="flex-1 w-full min-h-0 relative">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 20, right: 20, left: -20, bottom: 0 }}>
            ...
            />
            <Area type="monotone" dataKey="clicks" stroke="#00d4ff" fillOpacity={1} fill="url(#colorClicks)" strokeWidth={3} animationDuration={2000} />
            <Area type="monotone" dataKey="leads" stroke="#10b981" fillOpacity={1} fill="url(#colorLeads)" strokeWidth={4} animationDuration={2500} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
